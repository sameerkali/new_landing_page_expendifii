...
import { products, restaurantsData, site } from "@/lib/content";
    ...
    <>
      ...
      <RevealRoot>
        <main>
          ...
          {/* ---------------- sites we've built (landing pages only) ---------------- */}
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {restaurantsData.map((r, i) => (
                  <a
                    ...
                    className="group/site ease-expo relative flex flex-col justify-between gap-6 rounded-2xl border border-neutral-200 bg-white p-5 transition-all duration-500 hover:-translate-y-1 hover:border-neutral-300 hover:shadow-[0_22px_44px_-26px_rgba(15,15,15,0.2)]"
                  >
                    ...
                    <div className="flex items-center gap-2 font-mono text-[10px] tracking-[0.16em] text-neutral-400 uppercase">
                      <span className="bg-clay-bright h-1.5 w-1.5 rounded-full" />
                      {r.city}
                    </div>
                  </a>
